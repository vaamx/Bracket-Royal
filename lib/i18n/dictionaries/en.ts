export const en = {
  ...
  scorers: {
    ...
    eyebrow: "TOP SCORERS",
    title: "Golden Boot",
    intro: "Pick the 10 players you think will be the tournament's top scorers, predict each one's goal tally, then crown your Golden Boot.",
    progress: (n: number) => `${n}/10 picked`,
    goalsSet: (n: number, total: number) => `${n}/${total} goals set`,
  ...
  player: {
    ...
    predictGoals: "Predict their goals",
    onYourTop10: "On your Top 10",
    yourGoldenBoot: "Your Golden Boot 🥇",
    notFound: "Player not found",
    back: "Back",
    scoringTitle: "How they earn you points",
    scoringHit: (n: number) => `+${n} if they finish in the tournament's real Top 10`,
    scoringGoals: (exact: number, close: number) => `+${exact} for their exact goal tally, +${close} if you're within one`,
    scoringBoot: (boot: number, exact: number) => `+${boot} if you crown them and they win the Golden Boot, +${exact} more for exact goals`,
